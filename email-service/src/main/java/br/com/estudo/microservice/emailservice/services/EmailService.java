package br.com.estudo.microservice.emailservice.services;
...
public class EmailService {
    ...
    public void sendMail(final OrderCreatedMessage order) {
        ...
        try {
            ...
            log.info("Email enviado com sucesso para o cliente: {}", order.getCustomer().email());
            ...
            switch (e.getClass().getSimpleName()){
                ...
                case "MailSendException":
                    ...
                    break;
                default:
                    log.error("Erro inesperado ao enviar o e-mail: {}", e.getMessage());
            }
        }
    ...
    private String formatText(final OrderCreatedMessage order) {
